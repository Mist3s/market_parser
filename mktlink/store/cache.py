...
from mktlink.constants import CACHE_FRESH_TTL_PINNED_S, CACHE_FRESH_TTL_S

#: Псевдонимы констант. Числа живут в :mod:`mktlink.constants` (класс II),
#: потому что их же читают настройки, а настройкам нельзя импортировать
#: слой хранения: получилась бы петля «конфиг -> хранилище -> конфиг».
#: Обоснование каждого числа — там же, рядом с ним.
FRESH_TTL_S = CACHE_FRESH_TTL_S

FRESH_TTL_PINNED_S = CACHE_FRESH_TTL_PINNED_S
