...
#:   штрафа адресу.
#:
#: Потолки обоих подобраны так, чтобы уместиться в ``net_ms`` при бюджете
#: 15 с и оставить резидуал на ожидание спейсинга.
API_LADDER: dict[str, tuple[Rung, ...]] = {
    "ozon": (Rung("ozon.api_html", "replay", 9_000, 13_500),),
