...
#: (``SHORTEN_CAP_MS``). Отсюда 27 000: на промахе поставщик видит 25 500 мс,
#: на попадании — все 27 000.
#:
#: Чем за это платим: резидуал становится 2 215 мс, то есть МЕНЬШЕ гарда
...
API_LADDER: dict[str, tuple[Rung, ...]] = {
    "ozon": (Rung("ozon.api_html", "replay", 9_000, 27_000),),
