...
class Settings(BaseSettings):
    ...
    #: Повторять ли неудавшийся прямой запрос обходом: прокси из пула, а без
    #: него — scrape.do с российским адресом за 1 кредит (нужен токен).
    #: ЗАМЕР 2026-09-18: с боевого VPS восемь магазинов из четырнадцати
    #: молчат на TLS, так что без обхода они недоступны.
